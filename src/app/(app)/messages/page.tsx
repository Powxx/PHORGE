...
import { MessageCircle, ChevronRight, ArrowLeft, Clock } from 'lucide-react';
  ...
  return (
    <main className="min-h-screen bg-zinc-50 dark:bg-zinc-950 p-6 pt-10">
      <div className="max-w-xl mx-auto">
        ...
        {!isApproved ? (
          <div className="bg-white dark:bg-zinc-900 rounded-3xl p-8 border border-zinc-200 dark:border-zinc-800 shadow-sm text-center max-w-md mx-auto">
            ...
            <p className="text-sm text-zinc-500 mb-6 leading-relaxed">
              Un·e administrateur·rice du CFA doit valider votre profil avant que vous puissiez accéder à la messagerie.
            </p>
            <Link href="/profil" className="inline-block px-6 py-3 rounded-xl bg-[#D4AF37] hover:bg-[#B8962E] text-white font-bold transition-colors shadow-lg shadow-[#D4AF37]/20">
              Voir mon profil
            </Link>
          </div>
        ) : (
